                ...
                <div class="card-footer" style="border:0px; text-align: right;">
                    <c:choose>
                       <c:when test="${iss_catd_no eq 4 }">
                          <button class="btn btn--radius-2 btn--blue-2" type="button" onclick="check()">작성 완료</button>&nbsp;&nbsp;
                       ...
                       <c:when test="${iss_catd_no eq 5 }">
                          <button class="btn btn--radius-2 btn--blue-2" type="button">작성 완료</button>&nbsp;&nbsp;
