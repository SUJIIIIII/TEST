                    ...
                    <form action="funding.do?command=insertFunding" method="post" id="frm" enctype="multipart/form-data">
                        ...
                        <div class="form-row" style="border:0px;">
                            ...
                            <div class="input-group">
                                <input class="input--style-6" type="text" name="fund_title" maxlength="20" required="required">
                                </div>
                            </div>
                        </div>
                        <div class="form-row" style="border:0px;">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="text" name="fund_creator" maxlength="10" required="required" >
                                </div>
                            </div>
                        </div>
                        <div class="form-row" style="border:0px;">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    ...
                                    required="required" maxlength="10" oninput="maxLengthCheck(this)">
                                </div>
                            </div>
                        </div>
                         <div class="form-row" style="border:0px;">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6"  type="date" name="fund_deadline" required="required">   
                                </div>
                            </div>
                        </div>
                        <div class="form-row" style="border:0px;">
